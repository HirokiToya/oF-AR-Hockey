...
public:
    ...
    void setup();
    void draw(bool isSinglePlay);
    void update();
    void makeBall(ofVec2f frc, float scale);
    void FieldDrawing();
    void drawStaticLines();
    void drawRightPlayerSetting();
    void drawLeftPlayerSetting();
    void drawRightPlayerSetted();
    void drawLeftPlayerSetted();
    void drawRightDirection(int n, int length); // n: 破線の本数　length: 破線の長さ
    void drawLeftDirection(int n, int length);  // n: 破線の本数　length: 破線の長さ
